...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-12 items-center justify-center rounded-full bg-white/5 p-1 text-muted-foreground w-full backdrop-blur-md border border-white/10",
      className
    )}
    {...props}
  />
